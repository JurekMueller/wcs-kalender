// This file is taken from the @apollo/client-integration-nextjs docs
'use client';
...
function makeClient() {
  const baseURL =
    ...
    `https://${process.env.NEXT_PUBLIC_VERCEL_URL}`; // the latter is for vercel preview deployments
